...
TRANSLATIONS = {
    'en_US': {
        ...
        'selected_output_name': 'Selected output name',
        'output_name_placeholder': 'Output name for selected row',
        'scale': 'Scale',
        'preset': 'Preset',
        'sdk_mode': 'SDK mode',
        'rest_mode': 'Rest mode',
        'rest_vector': 'Rest vector',
        'scale_translate_limits': 'Scale translate limits',
        'scale_linear_animation': 'Scale animCurveTL translate animation',
        'scale_skin_bind_pre_matrices': 'Scale skin bindPreMatrix',
        'dry_run': 'Dry run',
        'write_report': 'Write report txt',
        'table_input_file': 'Input file',
        'table_output_name': 'Output name',
        'table_status': 'Status',
        'refresh_default_names': 'Refresh Default Names',
    ...
    'zh_CN': {
        ...
        'rest_mode': 'Rest 模式',
        'rest_vector': 'Rest 向量',
        'scale_translate_limits': '缩放位移限制',
        'scale_linear_animation': '缩放 animCurveTL 位移动画',
        'scale_skin_bind_pre_matrices': '缩放 skin bindPreMatrix',
        'dry_run': '仅分析',
        'write_report': '写出报告 txt',
        'table_input_file': '输入文件',
        'table_output_name': '输出名',
        'table_status': '状态',
        'refresh_default_names': '刷新默认输出名',
